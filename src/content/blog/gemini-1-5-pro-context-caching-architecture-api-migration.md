...
*   **[OpenAI Responses API Migration: Chat Completions Paradigm Shift](/blog/openai-responses-api-migration-chat-completions-paradigm-shift)** — Migration guide for OpenAI's stateful Responses API paradigm shift.
*   **[GitLab PostgreSQL replication lag directory deletion 6-hour total recovery](/blog/gitlab-postgresql-replication-lag-directory-deletion-6-hour-total-recovery)** — Database directory recovery and replication lag teardown.
*   **[Rogers Communications IP routing prefix distribution table overload national network crash](/blog/rogers-routing-table-overload-outage-2022)** — Routing table overload and core transport network recovery.
